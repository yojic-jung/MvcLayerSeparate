...
data class BoardDto(
    ...
    companion object {
        fun fromVoToDto(boardVo: BoardVo): BoardDto = BoardDto(
            boardId = boardVo.boardId,
            memId = boardVo.memId,
            boardTitle = boardVo.boardTitle,
            boardContents = boardVo.boardContents,
            sysUpdateTime = boardVo.sysUpdateTime,
            sysCreateTime = boardVo.sysCreateTime,
        )
    }
}
